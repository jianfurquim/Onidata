...
class UserTest(TestCase):
    ...
    def test_user_authentication(self):
        self.assertIsNotNone(
            authenticate(username="usertest1", password="test1userpass123")
        )
        self.assertIsNotNone(
            authenticate(username="usertest2", password="test2userpass123")
        )
    ...
    def test_superuser_creation(self):
        ...
        self.assertEqual(super_user1.get_full_name(), "SuperUser Test1")
        ...
        self.assertEqual(super_user2.get_full_name(), "SuperUser Test2")
    ...
    def test_superuser_authentication(self):
        self.assertIsNotNone(
            authenticate(username="superusertest1", password="test1superuserpass123")
        )
        self.assertIsNotNone(
            authenticate(username="superusertest2", password="test2superuserpass123")
        )
